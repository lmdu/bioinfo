...
class Member(BaseModel):
	...
	name_en = models.CharField(max_length=30, blank=True, verbose_name=_("英文名"))
	title_zh = models.CharField(max_length=255, blank=True, verbose_name=_("头衔(中文)"))
	title_en = models.CharField(max_length=255, blank=True, verbose_name=_("头衔(英文)"))
	...
	bio_zh = models.TextField(blank=True, verbose_name="个人简介(中文)")
	bio_en = models.TextField(blank=True, verbose_name="个人简介(英文)")
