# Generated by Django 2.0 on 2018-05-11 12:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mapkey', models.SmallIntegerField(choices=[(1, 'The disorder was positioned by mapping of the wildtype gene'), (2, 'The disease phenotype itself was mapped'), (3, 'The molecular basis of the disorder is known'), (4, 'The disorder is a chromosome deletion or duplication syndrome')], help_text='Phenotype mapping key')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('drug_type', models.IntegerField(choices=[(1, 'biotech'), (2, 'small molecule')], help_text='drugbank drug type')),
            ],
            options={
                'db_table': 'drug',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('source', models.IntegerField(choices=[(1, 'GO'), (2, 'KEGG'), (3, 'Pfam'), (4, 'InterPro')], db_index=True, help_text='The function source database name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feature', models.IntegerField(choices=[(1, 'CDS'), (2, 'Exon'), (3, "3'UTR"), (4, 'Intron'), (5, "5'UTR")], db_index=True, help_text='Gene features')),
            ],
            options={
                'db_table': 'gannot',
                'ordering': ['id'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('synonymous', models.IntegerField(choices=[(1, 'Synonymous'), (2, 'Non-synonymous')], db_index=True, help_text='Mutation type')),
            ],
            options={
                'db_table': 'mutation',
                'ordering': ['id'],
        ...
        migrations.AlterIndexTogether(
            name='speciesspecific',
            index_together={('snp', 'species'), ('snp', 'species', 'chromosome'), ('snp', 'chromosome')},
        ),
        migrations.AlterIndexTogether(
            name='snp',
        ...
        migrations.AlterIndexTogether(
            name='groupspecific',
            index_together={('snp', 'group', 'chromosome'), ('snp', 'group'), ('snp', 'chromosome')},
        ),
        migrations.AlterIndexTogether(
            name='gannot',
            index_together={('feature', 'gene', 'snp'), ('feature', 'snp'), ('feature', 'gene')},
        ),
        migrations.AlterIndexTogether(
            name='funcannot',
