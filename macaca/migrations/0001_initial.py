# Generated by Django 2.0.3 on 2018-03-27 03:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('drug_id', models.CharField(help_text='drugbank durg id', max_length=7)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('source', models.IntegerField(choices=[(1, 'GO'), (2, 'KEGG'), (3, 'Pfam'), (4, 'InterPro')], help_text='The function source database name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('chromosome', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='macaca.Chromosome')),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='macaca.Group')),
            ],
            options={
                'ordering': ['id'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('synonymous', models.IntegerField(choices=[(1, 'Non-synonymous'), (2, 'Synonymous')], db_index=True, help_text='Mutation type')),
            ],
            options={
                'ordering': ['id'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('human_ensembl', models.CharField(help_text='human ensembl gene id', max_length=18)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(help_text='Species group information', on_delete=django.db.models.deletion.CASCADE, to='macaca.Group')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AlterIndexTogether(
            name='speciesspecific',
            index_together={('snp', 'chromosome'), ('snp', 'species'), ('snp', 'species', 'chromosome')},
        ),
        migrations.AlterIndexTogether(
            name='snp',
        ...
        migrations.AlterIndexTogether(
            name='groupspecific',
            index_together={('snp', 'group'), ('snp', 'group', 'chromosome'), ('snp', 'chromosome')},
        ),
        migrations.AlterIndexTogether(
            name='gannot',
